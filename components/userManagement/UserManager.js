...
const UserManager = (props) => {
    ...
    return (
        <LoggedUserContext.Provider value={{
            ...
            jwtToken: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNjIwZmQyZWRjN2VmZmIwYWJiMDdjY2JmIiwiZW1haWwiOiJhZG1pbm1heCIsImlhdCI6MTY0NTU1MTI2MSwiZXhwIjoxNjQ1NTU0ODYxfQ.7fKcxFJ7dkY4fqiRFYcZwHKycI6PpwhIFvjS-doUvdI",
            userData: {
                "projects": {
                    "created": [
                ...
                "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNjIwZmQyZWRjN2VmZmIwYWJiMDdjY2JmIiwiZW1haWwiOiJhZG1pbm1heCIsImlhdCI6MTY0NTU1MTI2MSwiZXhwIjoxNjQ1NTU0ODYxfQ.7fKcxFJ7dkY4fqiRFYcZwHKycI6PpwhIFvjS-doUvdI"
            },
        }}>
            {props.children}
